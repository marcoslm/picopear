...
PicoPear es un conjunto de configuraciones, librerías y programas para hacer funcionar una placa de expansión muy económica de AliExpress (menos de 5€) diseñada para la Raspberry Pi Pico. 
